      ...
      <section className="pt-20 pb-24 bg-slate-50 dark:bg-slate-900/50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none space-y-8 text-slate-600 dark:text-slate-400 leading-relaxed">
            ...
            <h3 className="text-2xl font-display font-bold text-slate-900 dark:text-white pt-4">1. Information We Collect</h3>
            <p>
            ...
            <h3 className="text-2xl font-display font-bold text-slate-900 dark:text-white pt-4">2. How We Use Your Information</h3>
            <p>
            ...
            <h3 className="text-2xl font-display font-bold text-slate-900 dark:text-white pt-4">3. Data Security</h3>
            <p>
              We implement appropriate technical and organizational measures to protect the security of your personal information. However, please be aware that no method of transmission over the internet or method of electronic storage is 100% secure.
            </p>
            
            <h3 className="text-2xl font-display font-bold text-slate-900 dark:text-white pt-4">4. Your Rights</h3>
            <p>
