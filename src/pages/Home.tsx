  ...
  return (
    <div className="overflow-hidden">
      ...
      <section className="relative pt-32 pb-16 lg:pt-40 lg:pb-24">
        <GradientBackground />
        {/* Vignette Overlay */}
        <div className="absolute inset-0 bg-radial-[at_50%_50%] from-transparent via-transparent to-slate-950/10 dark:to-slate-950/40 pointer-events-none z-1" />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-left max-w-3xl mr-auto">
            <motion.div
              ...
              className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-brand-50 dark:bg-brand-900/30 border border-brand-100 dark:border-brand-800 text-brand-600 dark:text-brand-400 text-sm font-bold mb-4"
            >
            ...
            <motion.h1
              ...
              className="text-4xl md:text-5xl lg:text-6xl font-display font-bold tracking-tight text-slate-900 dark:text-white mb-6 leading-[1.1]"
            >
              Impactful Offshoring Solutions for <span className="text-gradient">Data, Cloud & Software</span>
            </motion.h1>
          ...
          <motion.div
            ...
            className="mt-24 p-4 rounded-3xl bg-white/50 dark:bg-slate-900/50 backdrop-blur-sm border border-white/20 dark:border-slate-800/50 shadow-2xl"
          >
            <div className="py-4 px-6 bg-brand-600 rounded-2xl text-white flex flex-col md:flex-row items-center justify-between gap-4">
              <div className="flex items-center gap-3">
                <CheckCircle2 size={24} className="text-brand-200" />
                <span className="font-bold text-lg tracking-tight">Hire and pay nothing for the first 7 days. Zero cost. Zero commitment.</span>
              </div>
              <Link to="/contact" className="px-6 py-2 bg-white text-brand-600 font-bold rounded-xl hover:bg-brand-50 transition-colors">
                Start Free Trial
              </Link>
            </div>
          </motion.div>
      ...
      <section className="py-24 bg-white dark:bg-slate-950">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row items-end justify-between gap-8 mb-16">
            ...
            <Link
              to="/services"
              className="px-6 py-3 font-bold text-brand-600 border border-brand-200 dark:border-brand-800 rounded-2xl hover:bg-brand-50 dark:hover:bg-brand-900/30 transition-all"
            >
              View All Services
            </Link>
          </div>
            ...
            {industries.map((industry, idx) => (
              ...
              >
                <Link
                  ...
                  className="block p-6 rounded-2xl bg-white/5 border border-white/10 hover:bg-white/10 hover:border-brand-500/50 transition-all text-center group"
                >
                  <span className="text-sm font-bold tracking-wide text-slate-300 group-hover:text-white transition-colors">
                    {industry}
                  </span>
                </Link>
              </motion.div>
