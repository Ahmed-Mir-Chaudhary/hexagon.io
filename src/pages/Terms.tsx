      ...
      <section className="pt-20 pb-24 bg-slate-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="prose prose-slate max-w-none space-y-8 text-slate-600 leading-relaxed">
            ...
            <h3 className="text-2xl font-display font-bold text-slate-900 pt-4">1. Use of Services</h3>
            <p>
            ...
            <h3 className="text-2xl font-display font-bold text-slate-900 pt-4">2. Intellectual Property</h3>
            <p>
            ...
            <h3 className="text-2xl font-display font-bold text-slate-900 pt-4">3. Limitation of Liability</h3>
            <p>
            ...
            <h3 className="text-2xl font-display font-bold text-slate-900 pt-4">4. Governing Law</h3>
            <p>
